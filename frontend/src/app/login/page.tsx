        ...
        <section className="hidden border-r border-white/10 p-10 lg:flex lg:flex-col lg:justify-between xl:p-16">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-400">
              Upload papers, generate summaries, ask questions,
              compare findings, create related work, and identify
              research gaps.
            </p>

            <div className="mt-10 space-y-4">
              <FeatureRow text="AI summaries and paper profiles" />
              <FeatureRow text="Research-aware question answering" />
              <FeatureRow text="Multi-paper comparison and synthesis" />
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="rounded-[28px] border border-white/10 bg-zinc-950/80 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl sm:p-8">
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-500">
                Continue working with your research library and AI workspace.
              </p>
